...
class ResidentDetailScreen extends ConsumerWidget {
  ...
  static final List<_MockTransaction> _transactions = [
    _MockTransaction("12/03/2024", 250.0, "Cotisation Mars", true),
    _MockTransaction("10/02/2024", 250.0, "Cotisation Février", true),
    _MockTransaction("01/01/2024", -250.0, "Débit Janvier", false),
  ];
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<User>(
        stream: (db.select(
          db.users,
        )..where((t) => t.id.equals(userId))).watchSingle(),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Appartement ${user.apartmentNumber}",
                            style: TextStyle(
                      ...
                      const Spacer(),
                      Text(
                        "${user.balance.toStringAsFixed(2)} DH",
                        style: TextStyle(
  ...
  Widget _buildTransactionTile(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          date,
          style: TextStyle(color: AppTheme.offWhite.withOpacity(0.5)),
        ),
        trailing: Row(
          ...
          children: [
            Text(
              "${amount > 0 ? '+' : ''}$amount DH",
              style: TextStyle(
                color: isCredit ? const Color(0xFF00E5FF) : AppTheme.errorRed,
                fontWeight: FontWeight.bold,
              ),
            ),
            if (isCredit)
...
class _MockTransaction {
  ...
  _MockTransaction(this.date, this.amount, this.description, this.isCredit);
}
